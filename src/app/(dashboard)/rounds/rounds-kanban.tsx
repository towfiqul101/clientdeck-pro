...
function RoundCard({ round }: { round: KanbanRound }) {
  ...
  return (
    <div className="w-[280px] shrink-0 rounded-xl border border-white/10 bg-[#1a1a2e] shadow-[var(--shadow-card)] transition-all duration-150 hover:-translate-y-0.5 hover:shadow-[var(--shadow-elevated)]">
      <Link href={workspaceHref} className="block border-b border-white/[0.06] p-3">
