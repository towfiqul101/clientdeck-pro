  ...
  if (status === "not_required") {
    return (
      <Card>
        ...
        <div className="px-5 py-4 text-sm text-gray-500">Not required for this client.</div>
      </Card>
    );
  }
          ...
          <dl className="space-y-1.5 text-gray-600">
            {signedAt && (
              <div className="flex justify-between gap-4">
                ...
                <dd className="font-medium text-gray-900">{formatDate(signedAt)}</dd>
              </div>
            )}
            {signatureType && (
              <div className="flex justify-between gap-4">
                <dt className="text-gray-500">Type</dt>
                <dd className="font-medium capitalize text-gray-900">{signatureType}</dd>
              </div>
            )}
            <div className="flex justify-between gap-4">
